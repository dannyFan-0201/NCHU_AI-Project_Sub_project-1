...
parser.add_argument('--data', metavar='DIR',default='C:/Users/user/Desktop/pytorch-image-models-main/timm/inference_test',
                    help='path to dataset')
parser.add_argument('--dataset', '-d', metavar='NAME', default='inference_test',
...
parser.add_argument('--num-classes', type=int, default=263,
...
parser.add_argument('--checkpoint', default='C:/Users/user/Desktop/pytorch-image-models-main/output/train/20230519-195256-resnet50-224/checkpoint-48.pth.tar', type=str, metavar='PATH',
