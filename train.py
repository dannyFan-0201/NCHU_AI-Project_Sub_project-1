...
parser.add_argument('--data_dir', default='C:/Users/user/Desktop/pytorch-image-models-main/timm/cowimg/',
                    help='path to dataset')
group.add_argument('--dataset', '-d', metavar='NAME', default='cowimg',
...
group.add_argument('--num-classes', type=int, default=263, metavar='N',
